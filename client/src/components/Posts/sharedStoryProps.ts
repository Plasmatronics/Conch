...
import { IMediaDimensions } from "./PostGallery/PostGallery.types";
...
export const vertVideo: Omit<IMediaDimensions, "height" | "width"> = {
	src: "https://www.youtube.com/watch?v=q-Y0bnx6Ndw&list=RDq-Y0bnx6Ndw&start_radio=1",
	type: "Video",
};

export const horizVideo: Omit<IMediaDimensions, "height" | "width"> = {
	src: "https://www.youtube.com/watch?v=q-Y0bnx6Ndw&list=RDq-Y0bnx6Ndw&start_radio=1",
	type: "Video",
};

export const vertImage: Omit<IMediaDimensions, "height" | "width"> = {
	src: "https://i.pinimg.com/736x/2d/95/e5/2d95e5886fc4c65a6778b5fee94a7d59.jpg",
	type: "Image",
};

export const threeHorizontalImages: Omit<
	IMediaDimensions,
	"height" | "width"
>[] = [
	{
